...
#include "delay.h"
 ...
 /**
  * @brief  I2C_Hardware_Init,初始化硬件IIC引脚
  * @param  无
  * @retval 无
  */
void I2C_Hardware_Init(void)
{
	...
	RCC_APB1PeriphClockCmd(RCC_APB1Periph_I2C1,ENABLE);//I2C1外设时钟使能 
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB,ENABLE);//I2C1外设GPIO时钟使能


	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;// I2C_SCL
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_OD;// 开漏输出
	GPIO_Init(GPIOB, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7;//I2C_SDA
	GPIO_Init(GPIOB, &GPIO_InitStructure);	
...
void OLED_Init(void)
{
	Delay_s(2);		// 2s,这里的延时很重要,上电后延时，没有错误的冗余设计
